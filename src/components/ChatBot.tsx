      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 z-50 w-[calc(100%-3rem)] sm:w-[400px] h-[600px] max-h-[80vh] flex flex-col rounded-3xl premium-glass border border-white/10 shadow-[0_20px_40px_rgba(0,0,0,0.5),0_0_80px_rgba(37,99,235,0.15)] overflow-hidden bg-[#0B121F]/95 backdrop-blur-xl"
          >
            {/* Header Section */}
