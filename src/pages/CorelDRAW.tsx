            ...
            <div className="space-y-8 relative z-10 text-left">
              ...
              <Reveal direction="up" delay={0.2}>
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2 w-full">
                  <Link to="/contact-us" className="btn-primary py-3 px-8 text-sm inline-flex items-center justify-center gap-2 group shadow-[0_0_20px_rgba(34,197,94,0.3)] border-[#22C55E] bg-[#22C55E] hover:bg-[#16A34A] hover:border-[#16A34A] w-full sm:w-auto">
